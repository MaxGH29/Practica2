...
public class Practica02_06_d extends JFrame implements ActionListener {
	...
	public Practica02_06_d() {
		...
		gbc1.gridy = 0;
		gbc1.gridheight = 1;
		getContentPane().add(panel1, gbc1);

		GridBagConstraints gbc2 = new GridBagConstraints();
		gbc2.gridx = 0;
		gbc2.gridy = 1;
		getContentPane().add(panel2, gbc2);

		GridBagConstraints gbc3 = new GridBagConstraints();
		gbc3.gridx = 0;
		gbc3.gridy = 2;
		gbc3.gridheight = 3;
		getContentPane().add(panel3, gbc3);

		GridBagConstraints gbc4 = new GridBagConstraints();
		gbc4.gridx = 0;
		gbc4.gridy = 5;
		getContentPane().add(panel4, gbc4);
	...
	public void Eliminar() {
		if (listaInsumo.idinsumos().length == 0) {
